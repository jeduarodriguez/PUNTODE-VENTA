    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row pb-0 md:pb-0 safe-area-top">
      ...
      <main className="flex-1 md:ml-64 relative flex flex-col h-[100dvh] overflow-hidden">
        ...
        <div className={`flex-1 overflow-y-auto p-4 md:p-8 ${view === 'pos' ? 'pb-0' : 'pb-24 md:pb-8'}`}>
          {/* Mobile Top Bar */}
          <div className="flex md:hidden items-center justify-between mb-4 sticky top-0 z-30 py-2 bg-gray-50/95 backdrop-blur-sm -mx-4 px-4 border-b border-gray-100">
            <div className="flex items-center gap-2">
              <span className="text-xl font-black text-gray-900">Pointy</span>
              <span className="text-indigo-600 font-black text-[8px] uppercase border border-indigo-100 px-1 rounded-sm">POS CLOUD</span>
            </div>
            <div className="flex items-center gap-2">
              <NetworkStatus onSyncComplete={(n) => showNotification(`✅ ${n} cambio(s) sincronizado(s)`)} />
              <button
                onClick={() => setIsRateModalOpen(true)}
                className="flex items-center gap-1 px-2 py-1 rounded-lg font-black text-[10px] uppercase bg-white text-indigo-600 border border-indigo-50 shadow-sm"
              >
